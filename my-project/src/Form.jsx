      ...
      <form className="block py-0 px-4 mt-[6rem] w-full font-spacegrotesk tracking-widest text-[#21092f] font-bold">
        <div className="flex flex-col">
            <label className="text-xs">CARDHOLDER NAME
              <input className="p-2 mt-1 w-full border-2 border-hsl(270, 3%, 87%) rounded-lg" type="text" placeholder="e.g. Jane Apples"/>
            </label>
          </div>

          <div className="flex flex-col">
            <label className="text-xs mt-2"> CARD NUMBER
              <input className="p-2 w-full mt-1 border-2 border-hsl(270, 3%, 87%) rounded-lg  font-spacegrotesk" type="number" placeholder="e.g. 1234 5678 9123 0000"/>
            </label>
          </div>
